...
with tf.Session() as sess:
    for i in range(kk):
        ...
        plt.ylim([0,1])
        plt.savefig((output_folder + "Accuracy_" + str(i) + ".eps"), dpi=150)
        ...
        plt.ylim([0,2])
        plt.savefig((output_folder + "Loss_" + str(i) + ".eps"), dpi=150)
    
        np.save(output_folder+"lstm_trainloss_"+str(i)+".npy",np.array(train_loss))
        np.save(output_folder+"lstm_valloss_"+ str(i)+".npy",np.array(validation_loss))
        np.save(output_folder+"lstm_trainacc_"+str(i)+".npy",np.array(train_acc))
        np.save(output_folder+"lstm_valacc_"+str(i)+".npy", np.array(validation_acc))
